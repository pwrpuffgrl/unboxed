...
def create_rag_prompt(question: str, context_chunks: list) -> str:
    ...
    prompt = f"""You are a helpful assistant that answers questions based on the provided context. Use the context below to answer the question. If the context contains relevant information, provide a comprehensive answer. Only say "I don't have enough information" if the context truly doesn't contain any relevant information about the question.
